    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try {
            ...
            if (journeyLocalDate.isBefore(currentDate)) {
                pw.println("<div class='tab'><p1 class='menu red'>Journey Date cannot be in the past!</p1></div>");
                return;
            }

            TrainBean train = trainService.getTrainById(trainNo);

            if (train != null && seat>0) {
                ...
                pw.println("<div class='tab'><p1 class='menu'>Invalid Train Number! or seats! </p1></div>");
